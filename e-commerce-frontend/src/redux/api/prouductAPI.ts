...
import { AllProductsResponse, CategoriesResponse, MessageResponse,  NewProductRequest,  ProductsResponse,  SearchProductsRequest, SearchProductsResponse } from "../../types/api-types";

...
export const getDashboard = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has(key))
        ...
        const [thisMonthProducts, thisMonthUsers, thisMonthOrders, lastMonthProducts, lastMonthUsers, lastMonthOrders, productsCount, usersCounts, allOrders, lastSixMonthOrders, categories, femaleUsersCount, lastestTransaction,] = await Promise.all([thisMonthProductsPromise,
...
export const getPieCharts = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has(key))
        ...
        const [processingOrder, shippedOrder, deliverdOrder, categories, productsCount, outOfStock, allOrders, allUsers, adminUsers, customerUsers,] = await Promise.all([
